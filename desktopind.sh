...
if [ $akm = 00 ] || [ $akm = 00 ]
then
echo $yellow"Apakah anda yakin ingin ke english version?"
echo $cyan"1.Ya"
echo $cyan"2.Tidak"
...
if [ $akm = 100 ] || [ $akm = 100 ]
then
echo $yellow"Apakah anda yakin keluat"
echo $purple"1.Ya"
echo $purple"2.Tidak"
...
if [ $umr -eq 1 ];
then
echo Terimakasih telah menggunakan tools kamo |lolcat
...
if [ $akm = 100 ] || [ $akm = 100 ]
then 
echo $yellow"Apakah Anda yakin untuk keluar" 
echo $purple"1.Ya" 
echo $purple"2.Tidak" 
read -p "Silahkan pilih:" umr; 
